	...
	public class FontComponent:AbstractComponent
	{
		...
		public override void start ()
		{
			...
			if (this.param ["size"] != "") {
                ...
                this.gameView.messageArea.GetComponent<GUIText> ().fontSize = size;
			}

			if (this.param ["color"] != "") {
				string color = this.param ["color"];
                //this.gameView.messageArea.GetComponent<GUIText> ().guiText.color = ColorX.HexToRGB (color);
                this.gameView.messageArea.GetComponent<GUIText> ().color = ColorX.HexToRGB (color);
			}
 ...
 */
	public class FontresetComponent:AbstractComponent
	{
		...
		public override void start ()
		{
            ...
            //this.gameView.messageArea.GetComponent<GUIText> ().guiText.fontSize = int.Parse(this.gameManager.getConfig ("messageFontSize"));
            this.gameView.messageArea.GetComponent<GUIText> ().color = ColorX.HexToRGB (this.gameManager.getConfig ("messageFontColor"));
            this.gameView.messageArea.GetComponent<GUIText> ().fontSize = int.Parse(this.gameManager.getConfig ("messageFontSize"));
			this.gameManager.nextOrder ();
